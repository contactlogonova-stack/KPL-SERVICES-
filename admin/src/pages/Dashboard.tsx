      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          <div className="p-6 border-b border-gray-100 flex justify-between items-center">
            ...
            <Link to='/reservations' className="text-sm text-[#E91E8C] hover:text-[#D81B80] font-medium flex items-center gap-1">
        ...
        >
          <div className="p-6 border-b border-gray-100 flex justify-between items-center">
            ...
            <Link to='/messages' className="text-sm text-[#E91E8C] hover:text-[#D81B80] font-medium flex items-center gap-1">
              Voir tout <ArrowRight className="w-4 h-4" />
            </Link>
          </div>
